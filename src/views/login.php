    ...
    <div class="w-full max-w-sm p-6 bg-white rounded-lg shadow-lg">
        ...
        <form id="loginForm" class="space-y-5">
            ...
            <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 rounded-lg 
                focus:ring-2 focus:ring-blue-500 focus:outline-none transition">Login</button>
        </form>

        <p class="mt-4 text-sm text-center text-gray-600">
            Don't have an account?
            <a href="register.php" class="text-blue-600 hover:text-blue-500 font-medium">Register</a>
        </p>
    </div>
